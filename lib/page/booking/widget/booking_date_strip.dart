...
class BookingDateStrip extends ConsumerWidget {
      ...
      child: Row(
        children: [
          _ArrowTap(
            ...
            onTap: () => ref.read(bookingListProvider.notifier).previousDay(),
          ),
          Expanded(
            child: Column(
          ...
          _ArrowTap(
            ...
            onTap: () => ref.read(bookingListProvider.notifier).nextDay(),
          ),
        ],
      ),
    );
